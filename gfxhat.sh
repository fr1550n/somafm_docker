...
productname="GFX HAT" # the name of the product to install
scriptname="gfxhat" # the name of this script
...
debpackage="" # the name of the package in apt repo
piplibname="gfxhat" # the name of the lib in pip repo
...
localdir="gfxhat" # the name of the dir for copy of resources
gitreponame="gfx-hat" # the name of the git project repo
...
pythondep=( "sn3218" "cap1xxx" ) # list of python dependencies
pipdeplist=( ) # list of dependencies to source from pypi
examplesdep=( "pil" ) # list of python modules required by examples
